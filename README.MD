...
<h3><b>1.  Embed in element HTML</b></h3>
    You simply add a "data-toggle = 'input-GMAP' 'on the desired element. example:
    ...
    e. You can set min and max of total marker which user can add to map via "data-min-marker" and "data-max-marker", example :
      " <input name='map' data-toggle='input-gmap' data-min-marker='0' data-max-marker='10'> "
...
<h3><b>*Note: type of latitude and longitude must be number</b></h3>
<h2><b>Options :</b></h2>
    a. width, default : 100
    b. height, default : 400
    c. points, default : Array()
    d. minMarker, default : 0
    e. maxMarker, default : 100
    f. latitude, default : -6.1750359
    g. longitude, default : 106.827192
